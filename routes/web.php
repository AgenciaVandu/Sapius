...
Route::group(['middleware' => ['admin'], 'prefix' => 'admin'], function () {
    ...
    Route::post('preguntas/exportar', 'Cursos\PreguntaController@exportar')->name('admin.preguntas.exportar');
    ...
    // Calendarios de Programacion
    Route::get('/registro/programacion/{curso_id}/calendarios', 'Registro\ProgrammingCalendarController@index')->name('admin.programming.calendar.index');
    Route::post('/registro/programacion/calendarios/store', 'Registro\ProgrammingCalendarController@store')->name('admin.programming.calendar.store');
    Route::post('/registro/programacion/calendarios/reorder', 'Registro\ProgrammingCalendarController@reorder')->name('admin.programming.calendar.reorder');
    Route::delete('/registro/programacion/calendarios/{id}', 'Registro\ProgrammingCalendarController@destroy')->name('admin.programming.calendar.destroy');
