...
@section('content')
    <div class="card">
        <div class="card-body text-center">
            ...
            <div class="badge badge-pill badge-light font-16">Teléfono: <a
                    href="tel:{{ Auth::user()->telefono }}">{{ Auth::user()->telefono }}</a></div>
        ...
        <div class="p-4 border-top mt-3">
            <div class="row text-center">
                <div class="col-6 border-right">
                    <h4 class="link d-flex align-items-center justify-content-center font-weight-medium">Universidad de
                        procedencia</h4>
                    ...
                    <div class="badge badge-pill badge-light font-16">Sustentación: {{ Auth::user()->fecha_sustentacion }}
                    </div>
                    <div class="badge badge-pill badge-light font-16">Folio: {{ Auth::user()->folio }}</div>
                </div>
                <div class="col-6">
                    <h4 class="link d-flex align-items-center justify-content-center font-weight-medium">Documentos
                        digitales</h4>
                    {{-- <a href="#" class="link d-flex align-items-center justify-content-center font-weight-medium">
                    ...
                    <p>
                        @if (Auth::user()->pase_ingreso !== null && Auth::user()->pase_ingreso !== '')
                            <a href="{{ URL::route(Auth::user()->rol[0]->slug . '.pase', ['file' => Auth::user()->pase_ingreso]) }}"
                        ...
                        @if (Auth::user()->documento_identificacion !== null && Auth::user()->documento_identificacion !== '')
                            <a href="{{ URL::route(Auth::user()->rol[0]->slug . '.documento', ['file' => Auth::user()->documento_identificacion]) }}"
                                class="btn btn-secondary">
