                            ...
                            <li class="glide__slide">
                                <div class="docentes__persona">
                                    <div class="maestro-img">
                                        <img src="{{ asset('storage/' . $teacher->img) }}" class="rounded-circle border-teachers" style="max-width: 15.4rem; max-height: 15.4rem; min-width: 15.4rem; min-height: 15.4rem; background: #ffffff;"
