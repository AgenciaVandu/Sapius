      ...
      <ul class="nav nav-tabs nav-justified" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active text-title2" id="pills-prepa-tab" data-toggle="pill" href="#prepa">
            <span>Entrar <br class="d-none d-sm-none d-md-none d-lg-block"> a la prepa</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-title2" id="pills-universidad-tab" data-toggle="pill" href="#universidad">
            <span>Entrar <br class="d-none d-sm-none d-md-none d-lg-block"> a la Universidad</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-title2" id="pills-maestria-tab" data-toggle="pill" href="#maestria">
            <span>Aprobar<br class="d-none d-sm-none d-md-none d-lg-block"> la Maestría</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-6 col-sm-12 m-auto orgullo-txt">
          ...
          <a href="" class="btn btn-primary" data-toggle="modal" data-target="#ventas">SOLICITAR UNA CLASE MUESTRA</a>
        </div>
