        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="fecha_sustentacion"
                            class="col-md-4 col-form-label text-md-right">{{ __('Fecha sustentación') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="universidad_procedencia"
                            class="col-md-4 col-form-label text-md-right">{{ __('Universidad de procedencia') }}</label>
                    ...
                    <div class="form-group row" id="rowImagen">
                        ...
                        <div class="col-md-6">
                            @if ($user->foto !== null && $user->foto !== '')
                                ...
                                <img id="img"
                                    src="{{ route(Auth::user()->rol[0]->slug . '.image', ['file' => $user->foto]) }}"
                                    alt="image" class="img-thumbnail" width="150" style="margin: 0 auto">
                                <a href="#" id="btnEliminarImagen" class="btn btn-danger btn-circle-lg"><i
                    ...
                    @if (Auth::user()->rol[0]->slug == 'admin' || Auth::user()->rol[0]->slug == 'alumno')
                        <div class="form-group row" id="rowImagen">
                            <label for="documento_identificacion"
                                class="col-md-4 col-form-label text-md-right">{{ __('Documento de identificación') }}</label>

                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" name="documento_identificacion" class="custom-file-input"
                            ...
                            @if ($user->documento_identificacion !== null && $user->documento_identificacion !== '')
                                <a href="{{ URL::route(Auth::user()->rol[0]->slug . '.documento', ['file' => $user->documento_identificacion]) }}"
                        ...
                        <div class="form-group row" id="rowImagen">
                            <label for="pase_ingreso"
                                class="col-md-4 col-form-label text-md-right">{{ __('Pase de ingreso') }}</label>

                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" name="pase_ingreso" class="custom-file-input"
                                        id="inputGroupFile02" accept="application/pdf">
                                    <label class="custom-file-label" for="inputGroupFile02"
                                        aria-describedby="inputGroupFileAddon02">
                            ...
                            @if ($user->pase_ingreso !== null && $user->pase_ingreso !== '')
                                <a href="{{ URL::route(Auth::user()->rol[0]->slug . '.pase', ['file' => $user->pase_ingreso]) }}"
                                    class="btn btn-secondary"><i class="fas fa-download"></i>
                                </a>
                            @endif
                        </div>
