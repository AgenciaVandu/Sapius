...
@push('meta')
    <title>{{ $meta_title ?? 'Modalidad Presencial - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Forma parte de nuestra comunidad Sapius. Vive la experiencia en modo Presencial' }}">
    <meta name="keywords"
    ...
    <meta name="image" content="{{ $meta_image ?? asset('img/v1/logo-sapius.svg') }}">
@endpush
@push('css')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 m-auto incluido__info">
                    ...
                    <p>Contamos con la tasa de aprobados más alta a nivel nacional, con una acreditación del 99.1%, con
                        resultados de excelencia.</p>
                    <hr>
                    ...
                    <p>Nuestros profesores cuentan con la máxima experiencia en docencia, cuentan con un amplio conocimiento
                        teórico – practico de la especialidad.</p>
                    <hr>
                    <h5>Contamos con descuentos por grupos y pago anticipado</h5>
                    <p>Programa de descuentos por grupos de estudiantes (Descuento dependiendo el número) y descuento por
                        pago anticipado.</p>
                    <hr>
                    <h5>Contamos con descuentos por grupos y pago anticipado</h5>
                    <p>Nuestros programas educativos cuentan con un grupo limitado de estudiantes con la finalidad de
                        brindar atención personalizada a cada estudiante, para la obtención de excelentes resultados.</p>
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#sapius-info">¡Solicita
                        una clase muestra!</button>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <h4 class="color-gray">Contamos con diferentes <br> horarios disponibles</h2>
                                <p class="color-gray">Lorem, ipsum dolor sit amet consectetur adipisicing elit. At
                                    recusandae eius earum et explicabo obcaecati modi tempore excepturi eligendi ut!</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 mt-5">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <h4 class="color-gray">Grupos <br> reducidos</h2>
                                <p class="color-gray">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis a
                                    maxime voluptatum eos ullam nesciunt ea. Perferendis blanditiis laboriosam eveniet!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-naranja">
            <div class="container text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <figure>
                            <img src="{{ asset('img/webp/entregables.webp') }}" class="entregables"
                                alt="Entregables Sapius">
                        </figure>
                    </div>
                </div>
                <div class="titular pt-2 pb-5">
                    <h5 class="color-gray">Maximiza tus oportunidades complementando tu preparación con nuestro <br
                            class="d-none d-sm-none d-md-block d-lg-block"> paquete escolar + el acceso al contenido
                        digital</span>
                        </h2>
                </div>
            </div>
