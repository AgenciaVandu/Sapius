    ...
    <div class="container pt-4">
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12 exani">
                ...
                <p class="color-gray">Ceneval. El Examen Nacional de Ingreso al Posgrado (EXANI-III) es un examen que proporciona información acerca del potencial que los aspirantes tienen para iniciar estudios de tipo superior.</p>
                <a href="" class="btn btn-primary">COMENZAR</a>
            </div>
