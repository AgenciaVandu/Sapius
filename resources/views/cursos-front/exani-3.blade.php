...
@section('content')
        ...
        <div class="container text-center">
            <div class="col-12 exani-titular">
                <h1 style="color: #fff;">Prepárate con Sapius <br>
                    Acredita el <span class=color-lowblue>EXANI-III</span> a la primera e <br
                        class="d-none d-sm-none d-md-block d-lg-block"> ingresa a la Maestría
                </h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-lg-7 col-sm-12 m-auto pb-4 exani__faq">
                    ...
                    <p class="color-gray">El Examen Nacional de Ingreso al Posgrado (EXANI-III) es un examen que proporciona
                        información acerca del potencial que los aspirantes tienen para iniciar estudios de tipo superior.
                    </p>
                    <a href="{{ route('register') }}" class="btn btn-primary">COMENZAR</a>
                </div>
    ...
    @include('components.info', ['content' => 'info', 'section' => 'exani3'])
@endsection
