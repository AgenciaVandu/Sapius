...
@push('meta')
    <title>{{ $meta_title ?? 'Simuladores Medicina - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate con Sapius Acredita el EGEL PLUS Medicina a la primera.' }}">
    <meta name="keywords"
        ...
        <div class="container text-center">
            <div class="col-12 exani-titular">
                <h1 style="color: #fff;">Prepárate con Sapius <br>
                    Acredita el <span class=color-lowblue>EGEL PLUS</span> MEDICINA con Sapius. <br
