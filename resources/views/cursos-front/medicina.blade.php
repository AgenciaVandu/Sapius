...
@push('meta')
    <title>{{ $meta_title ?? 'EGEL Plus Medicina - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate para acreditar el EGEL Plus MEDICINA a la primera. El 99.1% de nuestros estudiantes acreditan' }}">
    <meta name="keywords"
...
@section('content')
        ...
        <div class="container text-center">
            <div class="col-12 exani-titular">
                ...
                <h1 class="text-white font-weight-bold d-none d-md-block">
                    ...
                    <span class="color-lowblue">EGEL PLUS</span> MEDICINA con Sapius.
                    <br>
                    <small>El 99.1% de nuestros estudiantes acreditan</small>
                </h1>
            ...
            <div class="container text-center">
                <div class="posicion">
                    <h1 class="cta-1" style="color: #fff;">ACREDITA EL <span class="color-lowblue">EGEL PLUS
                            MEDICINA</span> CON EXCELENCIA <br> <span class="lead">El 40% de nuestros estudiantes obtiene
    ...
    @include('components.info', ['content' => 'info', 'section' => 'egel-plus'])
@endsection
