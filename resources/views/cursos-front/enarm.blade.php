...
@push('meta')
    <title>{{ $meta_title ?? 'ENARM - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate con Sapius El curso de residentes para futuros residentes.' }}">
    <meta name="keywords"
...
@section('content')
        ...
        <div class="container text-center">
            <div class="col-12 exani-titular">
                <h1 style="color: #fff;">Prepárate con Sapius <br>
                    El curso de<span class=color-lowblue> residentes</span> para <br
                        class="d-none d-sm-none d-md-block d-lg-block">futuros <span class=color-lowblue> residentes</span>
                </h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-lg-7 col-sm-12 m-auto pb-4 exani__faq">
                    ...
                    <p class="color-gray">Estamos enfocados 100% al examen ENARM. Con el fin de garantizar la acreditación y
                        el máximo aprovechamiento de cada alumno creamos nuestro método tutorial que te acompañará en el
                        camino con material didáctico actualizado.</p>
                    <a href="" class="btn btn-primary">COMENZAR</a>
                </div>
    ...
    @include('components.info', ['content' => 'info', 'section' => 'enarm'])
@endsection
