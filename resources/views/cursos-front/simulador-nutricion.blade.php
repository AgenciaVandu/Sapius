...
@push('meta')
    <title>{{ $meta_title ?? 'Simuladores EGEL Plus Nutrición - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate para el EGEL Plus – Nutrición con los Simuladores Sapius los más actualizados en un solo clic.' }}">
    <meta name="keywords"
    ...
    <meta name="image" content="{{ $meta_image ?? asset('img/simuladores-nutricion-SEO.jpg') }}">
@endpush
@push('css')
                                        ...
                                        <li class="glide__slide">
                                            <div class="card text-center mx-auto text-secondary"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text font-blod text-sm">{{ $simulador->identificador }}
                                                    </p>
