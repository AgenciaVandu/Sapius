...
@push('meta')
    <title>{{ $meta_title ?? 'Guía EGEL Plus Medicina - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate para el EGEL Plus – Medicina con la Guía Oficial Sapius la guía más actualizada en un solo clic.' }}">
    <meta name="keywords"
