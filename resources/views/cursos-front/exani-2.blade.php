...
@push('meta')
    <title>{{ $meta_title ?? 'EXANI-II - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate con Sapius Acredita el EXANI-II a la primera e ingresa a la Universidad' }}">
    <meta name="keywords"
...
@section('content')
        ...
        <div class="container  text-center">
            <div class="col-12 exani-titular">
                <h1 style="color: #fff;">Prepárate con Sapius <br>
                    Acredita el <span class=color-lowblue>EXANI-II</span> a la primera e <br
                        class="d-none d-sm-none d-md-block d-lg-block"> ingresa a la Universidad
                </h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-lg-7 col-sm-12 m-auto pb-4 exani__faq">
                    ...
                    <p class="color-gray">El Examen Nacional de Ingreso a la Educación Superior (EXANI-II) es una prueba de
                        razonamiento y conocimientos básicos, desarrollado para quienes pretenden cursar estudios de nivel
                        licenciatura.</p>
                    <a href="{{ route('register') }}" class="btn btn-primary">COMENZAR</a>
                </div>
    ...
    @include('components.info', ['content' => 'info', 'section' => 'exani2'])
@endsection
