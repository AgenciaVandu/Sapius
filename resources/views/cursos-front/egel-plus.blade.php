...
@push('meta')
    <title>{{ $meta_title ?? 'EGEL PLUS - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate con Sapius Acredita el EGEL PLUS a la primera.' }}">
    <meta name="keywords"
...
@section('content')
        ...
        <div class="container text-center">
            <div class="col-12 exani-titular">
                <h1 style="color: #fff;">Prepárate con Sapius <br>
                    Acredita el <span class=color-lowblue>EGEL PLUS</span> Sapius. <br
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-lg-7 col-sm-12 m-auto pb-4 exani__faq">
                    ...
                    <p class="color-gray">El propósito del EGEL plus es identificar si los egresados de la licenciatura
                        cuentan con los conocimientos y las habilidades necesarios para iniciarse eficazmente en el
                        ejercicio de la profesión.</p>
                    <a href="" class="btn btn-primary">COMENZAR</a>
                </div>
    ...
    <section id="experiencia">
        <div class="bg-2 mt-5">
            <div class="container text-center">
                <div class="posicion">
                    <h1 class="cta-1" style="color: #fff;">ACREDITA EL <span class="color-lowblue">EGEL PLUS</span> CON
                        EXCELENCIA <br> <span class="lead">El 40% de nuestros estudiantes obtiene
