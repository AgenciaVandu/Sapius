...
@push('meta')
    <title>{{ $meta_title ?? 'EXANI-I - Sapius®' }}</title>
    <meta name="description"
        content="{{ $meta_description ?? 'Prepárate con Sapius Acredita el EXANI-I a la primera e ingresa a la Preparatoria' }}">
    <meta name="keywords"
...
@section('content')
        ...
        <div class="container">
            <div class="col-12 exani-titular">
                <h1 style="color: #fff;">Prepárate con Sapius <br>
                    Acredita el <span class=color-lowblue>EXANI-I</span> a la primera e <br
                        class="d-none d-sm-none d-md-block d-lg-block"> ingresa a la Preparatoria
                </h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-lg-7 col-sm-12 m-auto exani__faq">
                    ...
                    <p class="color-gray">El EXANI-I es un examen que proporciona información acerca del potencial de los
                        aspirantes para tener un buen desempeño en estudios de tipo medio superior. Es utilizado para apoyar
                        los procesos de admisión en las instituciones de la educación media superior.</p>
                    <a href="{{ route('register') }}" class="btn btn-primary">COMENZAR</a>
                </div>
                <div class="col-md-5 col-lg-5 col-sm-12 text-center">
                    <div>
                        <img src="{{ asset('img/webp/exani-I.webp') }}" class="img-fluid" alt="Material exani 1"
                            loading="lazy">
                    </div>
                </div>
            </div>
    ...
    @include('components.info', ['content' => 'info', 'section' => 'exani1'])
@endsection
