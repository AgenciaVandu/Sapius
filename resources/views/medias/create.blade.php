...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route(Auth::user()->rol[0]->slug . '.medias.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="tipo" class="form-control @error('nombre') is-invalid @enderror"
                                    name="tipo" value="" required autocomplete="tipo" autofocus>
                        ...
                        <div class="form-group row" id="rowRuta">
                            ...
                            <div class="col-md-6">
                                <input id="ruta" type="text"
                                    class="form-control @error('ruta') is-invalid @enderror" name="ruta"
                                    value="{{ old('ruta') }}" autocomplete="ruta" autofocus>
                        ...
                        <div class="form-group row" id="rowArchivo">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                    <input type="checkbox" class="form-check-input ml-1" name="downloadable" >
                            </div>
                        </div>
            ...
            $('input[name="video_source"]').on('change', function() {
                if (this.value === 'file') {
                    ...
                    if ($('#ruta').val().trim() !== '' && !isUploading) {
                        ...
                        $('#videoUploadStatus').text('Archivo cargado previamente.');
