...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a href="/egel-plus" class="nav-link dropdown-toggle" id="navbarDropdown" role="button"
                            ...
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                @if (Auth::user()->foto !== null && Auth::user()->foto !== '')
                                    <img src="{{ asset('vendor/adminmart/assets/images/big/icon.png') }}" alt="user"
                                        class="img-fluid rounded-circle" style="width:40px">
                                @else
                                    <img src="{{ asset('vendor/adminmart/assets/images/big/icon.png') }}" alt="user"
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <small id="correo" class="form-text text-muted">No lo compartiremos con nadie
                                más</small>
                        </div>
                        <div class="form-group">
    ...
    <!-- Modal - maestros  -->
    <div class="modal fade" id="sapius-maestros" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="container pt-5">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-12 pt-2">
                        ...
                        <li>
                            <div class="row">
                                <a href="https://www.facebook.com/Sapius-latinoam%C3%A9rica-104931991400060"
                                    target="blank_"><i class="fab fa-facebook pl-3 pr-3 icono"></i></a>
                                <a href="https://www.instagram.com/sapius_latinoamerica/" target="blank_"><i
                                        class="fab fa-instagram pr-3 icono"></i></a>
                                <a href="https://twitter.com/_Sapius" target="blank_"><i
                                        class="fab fa-twitter pr-3 icono"></i></a>
                                <a href="https://www.tiktok.com/@sapiuslatinoamerica" target="blank_"><i
                                        class="fab fa-tiktok pr-3 icono"></i></a>
                                <a href="https://www.youtube.com/channel/UCDfPMHpBkAC2-SHi8Kxfitw" target="blank_"><i
                                        class="fab fa-youtube icono"></i></a>
                            </div>
                            <a href="https://api.whatsapp.com/send?phone=529992988744" target="blank_"
                                class="btn btn-light mt-2">ENVIANOS UN WHATSAPP</a>
                        </li>
                    </div>
                </div>
                        ...
                        <div class="pt-5" style="color: #fff;">
                            <p class="copyright" style="text-align: center;">
                                ...
                                <span class="pr-2"><a href="{{ asset('/politica-sapius.pdf') }}"
                                        target="blank_">Política de privacidad</a><span class="pl-2">|</span></span>
                                <br class="d-block d-sm-block d-md-none d-lg-none">
