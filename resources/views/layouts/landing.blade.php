...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-Q0PBBHC1SY"></script>
    <script>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/exani-1">EXANI-I</a>
                            <a class="dropdown-item" href="/exani-2">EXANI-II</a>
                            <a class="dropdown-item" href="/exani-3">EXANI-III</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        @if (Auth::check())
                            <a class="btn btn-primary" href="{{ route('login') }}">Ir al panel<div
                                    class="spinner-grow spinner-grow-sm text-white ml-2" role="status">
        ...
        <div class="container pt-5">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-5 col-sm-12 pt-2">
                    ...
                    <li>
                        <div class="row">
                            <a href="https://www.facebook.com/Sapius-latinoam%C3%A9rica-104931991400060"><i
                        ...
                        <a href="https://api.whatsapp.com/send?phone=529992988744" class="btn btn-light mt-2">ENVIANOS
                            UN WHATSAPP</a>
                    </li>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="pt-5" style="color: #fff;">
                        <p class="copyright" style="text-align: center;">
                            ...
                            <span class="pr-2"><a href="{{ asset('privacidad') }}">Política de
