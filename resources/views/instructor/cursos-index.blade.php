...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            var show =
                '<a class="btn btn-primary btn-detalle" href="javascript:void(0)" id="{{ route('instructor.cursos.show', 1) }}"><i class="fas fa-eye"></i></a>';
                ...
                .DataTable({
                    ...
                    "rowCallback": function(row, data) {
                        $(row).find('td:eq(2)').html(
                            '<form method="POST" action="{{ route('instructor.lecciones.index') }}"> @csrf <input name="curso_id" type="hidden" value="' +
                            data['id'] +
